...
void GLFWView::addRoutePlans() {
    ...
    lineString.push_back({ -74.015699, 40.70495 });
    lineString.push_back({ -74.015755, 40.704953 });
    lineString.push_back({ -74.01583, 40.704952 });
    ...
    lineString.push_back({ -74.016284, 40.70491 });
    ...
    lineString.push_back({ -74.015597, 40.70752 });
