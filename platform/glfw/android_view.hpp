...
class AndroidView : public mbgl::MapObserver {
public:
    AndroidView(bool fullscreen, bool benchmark, const mbgl::ResourceOptions &options, bool headless);
...
private:
    ...
    int width = nav::display::width();
    int height = nav::display::height();
    float pixelRatio;
