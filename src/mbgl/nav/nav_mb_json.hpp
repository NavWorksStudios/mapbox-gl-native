...
/*

 {
     ...
     "center": [-89.41046444900019, 47.52821702510292],
     "zoom": 6.5422107907098255,
     "bearing": 0,
     "pitch": 0,
     "lights": [],
     "sources": {
     ...
     "sprite": "mapbox://sprites/notheorem/clxk5j3qw00av01qq93udh6bm/2xt3h22bki4mfr63o7ugr129w",
     ...
     "layers": [{
         ...
         "paint": {
             "background-color": ["interpolate", ["linear"],
                 ["zoom"], 9, "hsl(222, 86%, 43%)", 11, "hsl(222, 85%, 29%)"
             ]
         },
         "metadata": {
         ...
         "filter": ["match", ["get", "class"],
             ["scrub", "grass"],
             ["step", ["zoom"], true, 8, false], true
         ],
         "type": "fill",
         "source": "composite",
         "id": "landcover",
         "paint": {
             "fill-color": "hsl(222, 86%, 25%)",
             "fill-opacity": ["interpolate", ["exponential", 1.5],
                 ["zoom"], 9, 0.4, 10, ["match", ["get", "class"], "crop", 0, 0.4], 11, ["match", ["get", "class"], "crop", 0, 0.4], 12, 0
             ],
         ...
         "paint": {
             "fill-color": ["interpolate", ["linear"],
                 ["zoom"], 14, ["match", ["get", "class"], "shadow", "hsla(222, 79%, 43%, 0.06)", "hsla(222, 86%, 37%, 0.04)"], 16, ["match", ["get", "class"], "shadow", "hsla(222, 79%, 43%, 0)", "hsla(222, 86%, 37%, 0)"]
             ],
             "fill-antialias": false
         },
         ...
         "paint": {
             ...
             "fill-color": ["interpolate", ["linear"],
                 ["zoom"], 6, ["interpolate", ["linear"],
                     ["get", "min_depth"], 0, "hsla(222, 79%, 23%, 0.35)", 200, "hsla(222, 79%, 22%, 0.95)", 7000, "hsla(222, 79%, 18%, 0.95)"
                 ], 8, ["interpolate", ["linear"],
                     ["get", "min_depth"], 0, "hsla(222, 79%, 23%, 0)", 200, "hsla(222, 79%, 22%, 0)", 7000, "hsla(222, 79%, 18%, 0)"
                 ]
             ]
         },
         "source-layer": "depth"
         ...
         "type": "line",
         "source": "composite",
         "id": "road-rail-bg-white",
         "paint": {
             "line-color": ["interpolate", ["linear"],
                 ["zoom"], 13, "hsl(0, 0%, 100%)", 17, "hsl(0, 0%, 100%)"
             ],
             "line-width": ["interpolate", ["exponential", 1.5],
                 ["zoom"], 14, 2, 20, 8
             ],
         ...
         "paint": {
             "line-color": ["interpolate", ["linear"],
                 ["zoom"], 13, "hsl(222, 79%, 27%)", 17, "hsl(222, 80%, 25%)"
             ],
             "line-width": ["interpolate", ["exponential", 1.5],
                 ["zoom"], 14, 1, 20, 5
             ],
         ...
         "paint": {
             "fill-extrusion-color": "hsl(222, 85%, 25%)",
         ...
         "paint": {
             ...
             "line-width": ["interpolate", ["linear"],
                 ["zoom"], 3, 0.44999999999999996, 12, 1.5
             ],
             "line-opacity": ["interpolate", ["linear"],
                 ["zoom"], 5, 0, 6, 1
             ],
             "line-color": "hsl(222, 86%, 52%)"
         },
         "source-layer": "admin"
     }, {
         "minzoom": 2,
         ...
         "paint": {
             "text-color": "hsl(222, 74%, 66%)",
             "text-halo-color": "hsl(222, 79%, 33%)",
             "text-halo-width": 1,
             "icon-opacity": 0.4
         },
         "source-layer": "structure"
         ...
         "paint": {
             "text-color": "hsl(222, 86%, 67%)",
             "text-halo-color": "hsl(222, 85%, 17%)",
             "text-halo-width": 0.5,
             "text-halo-blur": 0.5
         },
         ...
         "id": "waterway-label",
         "paint": {
             "text-color": "hsl(222, 84%, 49%)",
             "text-halo-color": "hsla(222, 85%, 17%, 0.5)"
         },
         ...
         "layout": {
             ...
             "text-offset": ["step", ["zoom"],
                 ["step", ["get", "sizerank"],
                     ["literal", [0, 0]], 5, ["literal", [0, 0.95]]
                 ], 17, ["step", ["get", "sizerank"],
                     ["literal", [0, 0]], 13, ["literal", [0, 0.95]]
                 ]
             ],
         ...
         "paint": {
             "text-color": ["step", ["get", "symbolrank"], "hsl(222, 86%, 80%)", 11, "hsl(222, 86%, 67%)", 16, "hsl(222, 86%, 61%)"],
             "text-halo-color": "hsl(222, 85%, 17%)",
             "text-halo-width": 1,
     ...
     "created": "2024-06-18T08:37:56.024Z",
     "modified": "2024-06-21T06:43:29.956Z",
     "id": "clxk5j3qw00av01qq93udh6bm",
     "owner": "notheorem",
     "visibility": "private",
     "protected": false,
     "draft": false
