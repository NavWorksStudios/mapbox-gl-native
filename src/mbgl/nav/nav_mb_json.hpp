...

{
     ...
     "center": [114.05990599138727, 22.771868582231406],
     "zoom": 15.087734051607944,
     "bearing": 113.90000000000009,
     "pitch": 0,
     "fog": {
         "range": [-1, 10],
         "color": "hsl(202, 61%, 91%)",
     ...
     "sprite": "mapbox://sprites/notheorem/clwvwdd2r01d301nyayhc6p6g/cpyjw7fa2sqpb675xj8f12gpy",
     ...
     "layers": [{
         ...
         "paint": {
             ...
             "fill-color": ["interpolate", ["linear"],
                 ["zoom"], 0, ["interpolate", ["linear"],
                     ["get", "min_depth"], 0, "rgba(54, 54, 54, 0.81)", 200, "hsla(215, 0%, 20%, 0.95)", 7000, "hsla(215, 0%, 17%, 0.95)"
                 ], 8, ["interpolate", ["linear"],
                     ["get", "min_depth"], 0, "hsla(215, 0%, 21%, 0)", 200, "hsla(215, 0%, 20%, 0)", 7000, "hsla(215, 0%, 17%, 0)"
                 ]
             ]
         },
         "source-layer": "depth"
         ...
         "paint": {
             "line-width": ["interpolate", ["exponential", 1.5],
                 ["zoom"], 13, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 3.6, ["secondary", "tertiary"], 2.25, ["motorway_link", "trunk_link", "street", "street_limited", "primary_link"], 0.9, 0.5
                 ], 18, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 28.8, ["secondary", "tertiary"], 23.400000000000002, ["motorway_link", "trunk_link", "street", "street_limited", "primary_link"], 16.2, 10.8
                 ], 22, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 288, ["secondary", "tertiary"], 234, ["motorway_link", "trunk_link", "primary_link", "street", "street_limited"], 162, 108
                 ]
             ],
         ...
         "filter": ["all", ["match", ["get", "oneway"],
                 ["true"], true, false
             ],
             ["match", ["get", "class"],
                 ["motorway", "motorway_link", "trunk", "trunk_link", "primary", "primary_link", "secondary", "secondary_link", "tertiary", "tertiary_link", "street", "street_limited", "intersection", "service", "ferry", "path", "track"], true, false
             ],
             ["match", ["get", "structure"],
                 ["none", "ford"], true, false
             ]
         ...
         "paint": {
             "line-width": ["interpolate", ["exponential", 1.5],
                 ["zoom"], 13, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 5.4, ["secondary", "tertiary"], 3.6, ["motorway_link", "trunk_link", "street", "street_limited", "primary_link"], 2.25, 1.125
                 ], 18, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 32.4, ["secondary", "tertiary"], 27, ["motorway_link", "trunk_link", "street", "street_limited", "primary_link"], 19.8, 14.4
                 ], 22, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary"], 324, ["secondary", "tertiary"], 270, ["motorway_link", "trunk_link", "primary_link", "street", "street_limited"], 198, 144
                 ]
             ],
         ...
         "filter": ["all", ["match", ["get", "structure"],
                 ["bridge"], true, false
             ],
             ["match", ["get", "oneway"],
                 ["true"], true, false
             ...
             ["match", ["get", "class"],
                 ["motorway", "motorway_link", "trunk", "trunk_link", "primary", "primary_link", "secondary", "secondary_link", "tertiary", "tertiary_link", "street", "street_limited"], true, false
             ]
         ],
         "type": "symbol",
         "source": "composite",
         ...
         "layout": {
             "text-size": ["interpolate", ["linear"],
                 ["zoom"], 10, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary", "secondary", "tertiary"], 14, 11.799999999999999
                 ], 18, ["match", ["get", "class"],
                     ["motorway", "trunk", "primary", "secondary", "tertiary"], 21.2, 18.8
                 ]
             ],
             "text-max-angle": 30,
             "symbol-spacing": 200,
         ...
         "paint": {
             "text-color": "rgba(214, 217, 229, 0.86)",
             "text-halo-color": "hsla(29, 68%, 27%, 0.86)",
             "text-halo-width": 0.5,
             "icon-opacity": 0.2
         },
         ...
         "layout": {
             "text-size": ["step", ["zoom"],
                 ["step", ["get", "sizerank"], 21.599999999999998, 5, 14.399999999999999], 17, ["step", ["get", "sizerank"], 21.599999999999998, 13, 14.399999999999999]
             ],
             "text-max-angle": 30,
             "text-field": ["coalesce", ["get", "name_zh-Hans"],
                 ["get", "name"]
         ...
         "layout": {
             ...
             "text-offset": ["step", ["zoom"],
                 ["step", ["get", "sizerank"],
                     ["literal", [0, 0]], 5, ["literal", [0, 1]]
                 ], 17, ["step", ["get", "sizerank"],
                     ["literal", [0, 0]], 13, ["literal", [0, 1]]
                 ]
             ],
         ...
         "paint": {
             ...
             "text-halo-width": 2,
             "text-halo-blur": 0.5,
             "text-color": "rgba(244, 245, 246, 0.86)"
         },
         ...
         "layout": {
             ...
             "text-size": ["step", ["get", "sizerank"], 21.599999999999998, 9, 14.399999999999999],
             "icon-image": "",
             "text-font": ["DIN Pro Italic", "Arial Unicode MS Regular"],
             "text-offset": [0, 0],
             "text-rotation-alignment": "viewport",
     ...
     "modified": "2024-06-16T08:59:58.206Z",
