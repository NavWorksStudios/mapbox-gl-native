...
struct ShaderSource<FillExtrusionProgram> {
    ...
    static const char* navVertex(const char* shaderSource, size_t preludeOffset) { return R"(
...
vec2 get_pattern_pos(const vec2 pixel_coord_upper,const vec2 pixel_coord_lower,const vec2 pattern_size,const float tile_units_to_pixels,const vec2 pos) {
    ...
    static const char* navVertex(const char* shaderSource) { return R"(
...
color+=ambientlight;float directional=clamp(dot(normal/16384.0,u_lightpos),0.0,1.0);
...
v_color*=u_opacity;}
    ...
    static const char* navFragment(const char* shaderSource, size_t preludeOffset) { return R"(
...
#define highp
    ...
    static const char* navFragment(const char* shaderSource) { return R"(
