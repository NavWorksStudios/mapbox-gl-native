...
template <>
struct ShaderSource<LineShadowProgram> {
    static constexpr const char* name = "line_shadow";
    static constexpr const uint8_t hash[8] = {0x7f, 0x8e, 0xaa, 0x53, 0x75, 0x78, 0xac, 0x2d};
...
constexpr const char* ShaderSource<LineShadowProgram>::name;
constexpr const uint8_t ShaderSource<LineShadowProgram>::hash[8];
...
template <>
std::unique_ptr<gfx::Program<LineShadowProgram>>
Backend::Create<gfx::Backend::Type::OpenGL>(const ProgramParameters& programParameters) {
    return std::make_unique<gl::Program<LineShadowProgram>>(programParameters);
}
