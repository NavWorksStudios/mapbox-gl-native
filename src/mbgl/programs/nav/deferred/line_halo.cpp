...
struct ShaderSource<LineHaloProgram> {
    ...
    static const char* navVertex(const char* ) { return R"(
        ...
        void main() {
            ...
            if (a_traffic_condition < 0.) v_color = vec4(0., 0., 0., 0.);
            else if (a_traffic_condition < 1.) v_color = vec4(.315, .539, .424, 1.);
            else if (a_traffic_condition < 2.) v_color = vec4(.354, .776, .463, 1.);
            else if (a_traffic_condition < 3.) v_color = vec4(.872, .754, .255, 1.);
            else if (a_traffic_condition < 4.) v_color = vec4(.872, .200, .255, 1.);
            else if (a_traffic_condition < 5.) v_color = vec4(.583, .142, .098, 1.);
        }
