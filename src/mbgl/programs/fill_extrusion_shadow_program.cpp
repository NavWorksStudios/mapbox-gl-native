...
static_assert(sizeof(FillExtrusionShadowLayoutVertex) == 12, "expected FillExtrusionLayoutVertex size");
...
FillExtrusionShadowProgram::LayoutUniformValues FillExtrusionShadowProgram::layoutUniformValues(
