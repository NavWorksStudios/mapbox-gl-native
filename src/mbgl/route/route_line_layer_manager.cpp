...
// static
const LayerTypeInfo* RouteLineLayerManager::Impl::staticTypeInfo() noexcept {
...
RouteLineLayerManager::RouteLineLayerManager(const std::string& layerID)
    : Layer(makeMutable<Impl>(layerID, std::string())) {
}

RouteLineLayerManager::RouteLineLayerManager(Immutable<Impl> impl_)
    : Layer(std::move(impl_)) {
}

RouteLineLayerManager::~RouteLineLayerManager() = default;

const RouteLineLayerManager::Impl& RouteLineLayerManager::impl() const {
    return static_cast<const Impl&>(*baseImpl);
}

Mutable<RouteLineLayerManager::Impl> RouteLineLayerManager::mutableImpl() const {
    return makeMutable<Impl>(impl());
}

std::unique_ptr<Layer> RouteLineLayerManager::cloneRef(const std::string& id_) const {
    auto impl_ = mutableImpl();
    impl_->id = id_;
    impl_->paint = LocationIndicatorPaintProperties::Transitionable();
    return std::make_unique<RouteLineLayerManager>(std::move(impl_));
}

void RouteLineLayerManager::Impl::stringifyLayout(rapidjson::Writer<rapidjson::StringBuffer>& writer) const {
    layout.stringify(writer);
}

// Layout properties

PropertyValue<expression::Image> RouteLineLayerManager::getDefaultBearingImage() {
    return BearingImage::defaultValue();
}

const PropertyValue<expression::Image>& RouteLineLayerManager::getBearingImage() const {
    return impl().layout.get<BearingImage>();
}

void RouteLineLayerManager::setBearingImage(const PropertyValue<expression::Image>& value) {
...
PropertyValue<expression::Image> RouteLineLayerManager::getDefaultShadowImage() {
    return ShadowImage::defaultValue();
}

const PropertyValue<expression::Image>& RouteLineLayerManager::getShadowImage() const {
    return impl().layout.get<ShadowImage>();
}

void RouteLineLayerManager::setShadowImage(const PropertyValue<expression::Image>& value) {
...
PropertyValue<expression::Image> RouteLineLayerManager::getDefaultTopImage() {
    return TopImage::defaultValue();
}

const PropertyValue<expression::Image>& RouteLineLayerManager::getTopImage() const {
    return impl().layout.get<TopImage>();
}

void RouteLineLayerManager::setTopImage(const PropertyValue<expression::Image>& value) {
...
PropertyValue<float> RouteLineLayerManager::getDefaultAccuracyRadius() {
    return {0};
}

const PropertyValue<float>& RouteLineLayerManager::getAccuracyRadius() const {
    return impl().paint.template get<AccuracyRadius>().value;
}

void RouteLineLayerManager::setAccuracyRadius(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setAccuracyRadiusTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<AccuracyRadius>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getAccuracyRadiusTransition() const {
    return impl().paint.template get<AccuracyRadius>().options;
}

PropertyValue<Color> RouteLineLayerManager::getDefaultAccuracyRadiusBorderColor() {
    return {Color::white()};
}

const PropertyValue<Color>& RouteLineLayerManager::getAccuracyRadiusBorderColor() const {
    return impl().paint.template get<AccuracyRadiusBorderColor>().value;
}

void RouteLineLayerManager::setAccuracyRadiusBorderColor(const PropertyValue<Color>& value) {
...
void RouteLineLayerManager::setAccuracyRadiusBorderColorTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<AccuracyRadiusBorderColor>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getAccuracyRadiusBorderColorTransition() const {
    return impl().paint.template get<AccuracyRadiusBorderColor>().options;
}

PropertyValue<Color> RouteLineLayerManager::getDefaultAccuracyRadiusColor() {
    return {Color::white()};
}

const PropertyValue<Color>& RouteLineLayerManager::getAccuracyRadiusColor() const {
    return impl().paint.template get<AccuracyRadiusColor>().value;
}

void RouteLineLayerManager::setAccuracyRadiusColor(const PropertyValue<Color>& value) {
...
void RouteLineLayerManager::setAccuracyRadiusColorTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<AccuracyRadiusColor>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getAccuracyRadiusColorTransition() const {
    return impl().paint.template get<AccuracyRadiusColor>().options;
}

PropertyValue<Rotation> RouteLineLayerManager::getDefaultBearing() {
    return {0};
}

const PropertyValue<Rotation>& RouteLineLayerManager::getBearing() const {
    return impl().paint.template get<Bearing>().value;
}

void RouteLineLayerManager::setBearing(const PropertyValue<Rotation>& value) {
    if (value == getBearing())
        return;
    auto impl_ = mutableImpl();
...
void RouteLineLayerManager::setBearingTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<Bearing>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getBearingTransition() const {
    return impl().paint.template get<Bearing>().options;
}

PropertyValue<float> RouteLineLayerManager::getDefaultBearingImageSize() {
    return {1};
}

const PropertyValue<float>& RouteLineLayerManager::getBearingImageSize() const {
    return impl().paint.template get<BearingImageSize>().value;
}

void RouteLineLayerManager::setBearingImageSize(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setBearingImageSizeTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<BearingImageSize>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getBearingImageSizeTransition() const {
    return impl().paint.template get<BearingImageSize>().options;
}

PropertyValue<float> RouteLineLayerManager::getDefaultImageTiltDisplacement() {
    return {0};
}

const PropertyValue<float>& RouteLineLayerManager::getImageTiltDisplacement() const {
    return impl().paint.template get<ImageTiltDisplacement>().value;
}

void RouteLineLayerManager::setImageTiltDisplacement(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setImageTiltDisplacementTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<ImageTiltDisplacement>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getImageTiltDisplacementTransition() const {
    return impl().paint.template get<ImageTiltDisplacement>().options;
}

PropertyValue<std::array<double, 3>> RouteLineLayerManager::getDefaultLocation() {
    return {{{0, 0, 0}}};
}

const PropertyValue<std::array<double, 3>>& RouteLineLayerManager::getLocation() const {
    return impl().paint.template get<Location>().value;
}

void RouteLineLayerManager::setLocation(const PropertyValue<std::array<double, 3>>& value) {
...
void RouteLineLayerManager::setLocationTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<Location>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getLocationTransition() const {
    return impl().paint.template get<Location>().options;
}

PropertyValue<float> RouteLineLayerManager::getDefaultPerspectiveCompensation() {
    return {0.85};
}

const PropertyValue<float>& RouteLineLayerManager::getPerspectiveCompensation() const {
    return impl().paint.template get<PerspectiveCompensation>().value;
}

void RouteLineLayerManager::setPerspectiveCompensation(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setPerspectiveCompensationTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<PerspectiveCompensation>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getPerspectiveCompensationTransition() const {
    return impl().paint.template get<PerspectiveCompensation>().options;
}

PropertyValue<float> RouteLineLayerManager::getDefaultShadowImageSize() {
    return {1};
}

const PropertyValue<float>& RouteLineLayerManager::getShadowImageSize() const {
    return impl().paint.template get<ShadowImageSize>().value;
}

void RouteLineLayerManager::setShadowImageSize(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setShadowImageSizeTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<ShadowImageSize>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getShadowImageSizeTransition() const {
    return impl().paint.template get<ShadowImageSize>().options;
}

PropertyValue<float> RouteLineLayerManager::getDefaultTopImageSize() {
    return {1};
}

const PropertyValue<float>& RouteLineLayerManager::getTopImageSize() const {
    return impl().paint.template get<TopImageSize>().value;
}

void RouteLineLayerManager::setTopImageSize(const PropertyValue<float>& value) {
...
void RouteLineLayerManager::setTopImageSizeTransition(const TransitionOptions& options) {
    auto impl_ = mutableImpl();
    impl_->paint.template get<TopImageSize>().options = options;
    baseImpl = std::move(impl_);
}

TransitionOptions RouteLineLayerManager::getTopImageSizeTransition() const {
...
StyleProperty getLayerProperty(const RouteLineLayerManager& layer, Property property) {
    switch (property) {
...
StyleProperty getLayerProperty(const RouteLineLayerManager& layer, const std::string& name) {
...
Value RouteLineLayerManager::serialize() const {
...
optional<Error> RouteLineLayerManager::setPropertyInternal(const std::string& name, const Convertible& value) {
    const auto it = layerProperties.find(name.c_str());
    if (it == layerProperties.end()) return Error{std::string(name) + " <- RouteLineLayerManager doesn't support this property"};
    ...
    return Error{std::string(name) + " <- RouteLineLayerManager doesn't support this property"};
}

StyleProperty RouteLineLayerManager::getProperty(const std::string& name) const {
    return getLayerProperty(*this, name);
}

Mutable<Layer::Impl> RouteLineLayerManager::mutableBaseImpl() const {
